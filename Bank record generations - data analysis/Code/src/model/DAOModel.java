...
public class DAOModel {
	...
	public void createTable() {
		try {
			...
			String sql = "CREATE TABLE BankDetailTable06 " + "(pid INTEGER not NULL AUTO_INCREMENT, "
	...
	public void insertRecords(BankRecords[] robjs) {
		try {
			...
			for (int i = 0; i < robjs.length; ++i) {
				...
				sql = "INSERT INTO BankDetailTable06(id,income,pep) " + "VALUES (' " + robjs[i].getId()
	...
	public ResultSet retrieveRecords() {
		...
		try {
			...
			String sql = "SELECT pid,id,income,pep from BankDetailTable06 order by pep desc";
